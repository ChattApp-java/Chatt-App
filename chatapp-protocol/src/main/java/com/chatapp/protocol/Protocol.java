...
public class Protocol {
    ...
    // ── Limites de sécurité ───────────────────────────────────
    public static final int MAX_MESSAGE_LENGTH = 4096; // longueur max message texte
    public static final int MAX_FILE_SIZE = 10 * 1024 * 1024; // 10 MB max fichier
    public static final int PROTOCOL_VERSION = 1; // version du protocole
